...
const getLeaderboard = (playerId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const surrondingPlayers = yield redis_1.client.zRangeWithScores(constants_1.LEADERBOARD_WEEKLY, start, end, { REV: true });
        ...
        const allPlayers = [
            ...top100Players,
            ...surrondingPlayers.filter((player) => !top100PlayerIds.has(player.value)),
        ];
